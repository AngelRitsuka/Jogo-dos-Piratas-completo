...
//sensor da risada desligado no inicio
...
function draw() {
  ...
  //pontuação, tirando da biblioteca jQuerry
  fill("#6d4c41");
  textSize(40);
...
function showBoats() {
  if (boats.length > 0) {
    ...
    for (var i = 0; i < boats.length; i++) {
      ...
      //Navio tocou na torre? Está quebrado?
      if (collision.collided && !boats[i].isBroken) {
          //Dar risada apenas uma vez quando for gameOver
